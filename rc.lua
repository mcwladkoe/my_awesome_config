...
kbdcfg.add_primary_layout("Русский", "UA", "ua")
...
globalkeys = gears.table.join(
    ...
    awful.key({ "Mod1" , "Control"}, "space", function () kbdcfg.switch_next() end),

    -- Switch the keyboard layout -- 2 Shifts
--    awful.key({ "shift" }, "Shift_R", function () kbdcfg.switch() end),
--    awful.key({ "Shift_R" }, "Shift_L", function () kbdcfg.switch() end),

    -- Lock screen on press Alt Ctrl l
    awful.key({ "Mod1" , "Control"}, "l", function () os.execute("xscreensaver-command -lock") end, {description = "Lock Screen", group = "launcher"}),
...
clientkeys = gears.table.join(
    ...
    awful.key({ modkey,}, "e", function () awful.screen.focus_relative(1) end,
        {description = "move another screen", group = "tag"}),
    awful.key({ modkey,           }, "f",
        function (c)
